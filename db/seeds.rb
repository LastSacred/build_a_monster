...
flamethrower_arms = Arm.create(name: "Flamethrower Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 115, power:391, defense: 370, cuteness: 8)
bear_arms = Arm.create(name: "Bear Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 107, power:245, defense: 521, cuteness: 15)
gun_arms = Arm.create(name: "Gun Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 100, power:35, defense: 420, cuteness: 19)
hook_arms = Arm.create(name: "Hook Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 88, power:235, defense: 343, cuteness: 6)
lobster_arms = Arm.create(name: "Lobster Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 94, power:186, defense: 920, cuteness: 13)
shield_arms = Arm.create(name: "Shield Arms", limg: "bear_arms", rimg: "lobster_arms", weight: 136, power:77, defense: 950, cuteness: 5)
...
rocket_legs = Leg.create(name: "Rocket Legs", img: "tank_legs.png", weight: 380, power: 261, defense: 763, speed: 191)
...
mustache_head = Head.create(name: "Mustache Head", img: "laser_eyes_head.png", weight: 32, power: 18, defense: 54, cuteness: 12, intelligence: 10)
...
sumo_torso = Torso.create(name: "Sumo Torso", img: "lumberjack_torso.png", weight: 600, power: 103, defense: 708, dadbod: true)

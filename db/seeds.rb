...
flamethrower_arms = Arm.create(name: "Flamethrower Arms", limg: "flamethrower_arms", rimg: "flamethrower_arms", weight: 115, power:391, defense: 370, cuteness: 8)
bear_arms = Arm.create(name: "Bear Arms", limg: "bear_arms", rimg: "bear_arms", weight: 107, power:245, defense: 521, cuteness: 15)
...
lobster_arms = Arm.create(name: "Lobster Arms", limg: "lobster_arms", rimg: "lobster_arms", weight: 94, power:186, defense: 920, cuteness: 13)
